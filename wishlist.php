...
<h4 class="col-lg-3" style="padding:10px;">Wishlist</h4>
</section><hr>
<?php
$c=$_SESSION['USER_ID'];


      $result = $db->prepare("select p.*,w.id as wishlist from product p,wishlist w where w.p_id=p.id and w.c_id='$c'");
      $result->execute();
            ...
            <div class="card card-body" style="margin-bottom:10px;">
                            <div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
                                ...
                                <span class="btn-success" style="padding:2px 5px;font-size:12px; border-radius:5px;">
                                    ...
                                    <a href="remove_wishlist.php?id=<?php echo $row['wishlist']; ?>" class="round-black-btn mt-4 text-white"><i class="icon-cart-add mr-2"></i> Remove</a>
                                </div>
                            </div>
                        </div>

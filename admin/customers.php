...
<section class="content-header" style="display:flex;justify-content:space-between">
		...
		<a href="blocked_customer.php" class="btn btn-primary btn-sm" style="float:right;margin:0px 750px;">Blocked Customers</a>
</section>
							...
							$result = $db->prepare("select * from customer where status='1'");
								...
								for($i=0; $row = $result->fetch(); $i++)
								{
									...
									<tr>
										...
										<td><a href="c_block.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">block</a></td>
									</tr>
									<?php
								}

...
<section class="content-header" style="display:flex;justify-content:space-between">
		...
		<h1 class="col-lg-3">Active Sellers</h1>
	
		<a href="blocked_seller.php" class="btn btn-primary btn-sm" style="float:right;margin:0px 750px;">Blocked Sellers</a>
</section>
				...
				<div class="">
					...
					<thead class="thead-dark">
						...
						<tbody>
							<?php
							$i=1;
							$result = $db->prepare("select * from seller where status='1'");
								$result->execute();
								for($i=0; $row = $result->fetch(); $i++)
								{
									...
									<tr>
										...
										<td><a href="s_block.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">block</a></td>
									</tr>
									<?php
								}

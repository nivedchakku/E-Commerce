...
<section class="content-header" style="display:flex;justify-content:space-between">
		...
		<h1 class="col-lg-3">Completed Orders</h1>
				...
				<div class="">
					...
					<thead class="thead-dark">
						...
						<tbody>
							<?php
							$i=1;
							$result = $db->prepare("select p.name as p_name,p.id as p_id,p.customizable as customizable,pay.status as p_status,o.c_id as c_id,op.* from product p,payment pay,orders o,ordered_products op where op.order_id=o.id and o.id=pay.order_id and op.p_id=p.id and p.s_id='$seller_id' and op.status=3");
								$result->execute();
